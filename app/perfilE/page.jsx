...
export default function PerfilEmp(){
    ...
    return(
        ...
        <button className="h-52 justify-center inline-flex flex-col items-center px-3 py-2 text-sm font-medium text-center text-white bg-salmonColor rounded-lg hover:bg-naranjaLogo focus:ring-4 focus:outline-none focus:ring-colorIcons">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-3xl mb-2">
